...
TEST_F(Vector3Fixture, test_operator_scalar_plus_vector)
{
    Vec3f res{2.0f + v1};
...
TEST_F(Vector3Fixture, test_operator_scalar_minus_vector)
{
    Vec3f res{2.0f - v1};
...
TEST_F(Vector3Fixture, test_operator_scalar_mult_vector)
{
    Vec3f res{2.0f * v1};
...
TEST_F(Vector3Fixture, test_operator_scalar_div_vector)
{
    Vec3f res{2.0f / v1};
