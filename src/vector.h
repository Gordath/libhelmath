...
public:
    union {
        ...
        swizzle<2, 2, 3, 0> ppqs;
        swizzle<2, 2, 3, 1> ppqt;
        swizzle<2, 2, 3, 2> ppqp;
        swizzle<2, 2, 3, 3> ppqq;
        swizzle<2, 3, 0, 0> pqss;
        swizzle<2, 3, 0, 1> pqst;
        swizzle<2, 3, 0, 2> pqsp;
        swizzle<2, 3, 0, 3> pqsq;
        swizzle<2, 3, 1, 0> pqts;
        swizzle<2, 3, 1, 1> pqtt;
        swizzle<2, 3, 1, 2> pqtp;
        swizzle<2, 3, 1, 3> pqtq;
        swizzle<2, 3, 2, 0> pqps;
        swizzle<2, 3, 2, 1> pqpt;
        swizzle<2, 3, 2, 2> pqpp;
        swizzle<2, 3, 2, 3> pqpq;
        swizzle<2, 3, 3, 0> pqqs;
        swizzle<2, 3, 3, 1> pqqt;
        swizzle<2, 3, 3, 2> pqqp;
        swizzle<2, 3, 3, 3> pqqq;
